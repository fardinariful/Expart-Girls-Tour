...
const Footer = () => {
    return (
        <div>
            {/* <footer className="footer bg-white text-base-content p-16 mt-28">
                <div className='flex flex-row justify-center items-center gap-48'>
                    <div>
                        ...
                        <p className='text-[#475467] font-medium'>
                            Scan a Turning Hearts Medallion to learn about and interact <br /> with those who have passed on. You can also begin <br /> documenting the legacy you wish to leave behind.
                        </p>
            ...
            <footer className="footer bg-white text-base-content p-16 mt-28 relative">
                <div className="flex flex-row justify-center items-center gap-48">
                    <div>
                        <img src={IMG} className="w-36 h-32" alt="" />
                        <p className="text-[#475467] font-medium">
                ...
                {/* Adding the copyright warning at the bottom right */}
